...
\begin{center}
\vspace*{.03cm}
\Large\textbf{Experimento 02:}\\ %titulo
\Large{Leis de Kirchhoff}
\end{center}
\justify

\section{Objetivos}

O objetivo deste experimento é a prática do método dos nós e das malhas para análise de circuitos eletrônicos. São abordadas
as resoluções de circuitos utilizando estes métodos, bem como a montagem dos circuitos correspondentes e sua verificação
experimental através da medição das grandezas elétricas consideradas nas resoluções.

\input{estudo_pre_laboratorial.tex}
